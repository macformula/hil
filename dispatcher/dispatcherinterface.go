...
// func NewDispatcher2(l *zap.Logger, port int) *Dispatcher {
// 	server := &http.Server{
...
// func (d *Dispatcher) Open2(ctx context.Context) error {
...
// func (d *Dispatcher) Trigger2(ctx context.Context) error {
...
// func (d *Dispatcher) Close2(ctx context.Context) error {
// 	if !d.stop {
