...
var _revisionDigitalInputPinout = map[Revision]DigitalPinout{
	...
	Sil: {
		...
		TsalEn:                     sil.NewDigitalInputPin(fwutils.LvController.String(), TsalEn.String()),
		RaspiEn:                    sil.NewDigitalInputPin(fwutils.LvController.String(), RaspiEn.String()),
		FrontControllerEn:          sil.NewDigitalInputPin(fwutils.LvController.String(), FrontControllerEn.String()),
		SpeedgoatEn:                sil.NewDigitalInputPin(fwutils.LvController.String(), SpeedgoatEn.String()),
		MotorControllerEn:          sil.NewDigitalInputPin(fwutils.LvController.String(), MotorControllerEn.String()),
		ImuGpsEn:                   sil.NewDigitalInputPin(fwutils.LvController.String(), ImuGpsEn.String()),
		DcdcEn:                     sil.NewDigitalInputPin(fwutils.LvController.String(), DcdcEn.String()),
		DcdcEnLed:                  sil.NewDigitalInputPin(fwutils.LvController.String(), DcdcEnLed.String()),
		PowerTrainPumpEn:           sil.NewDigitalInputPin(fwutils.LvController.String(), PowerTrainPumpEn.String()),
		PowertrainFanEn:            sil.NewDigitalInputPin(fwutils.LvController.String(), PowertrainFanEn.String()),
		AccumulatorEn:              sil.NewDigitalInputPin(fwutils.LvController.String(), AccumulatorEn.String()),
		ShutdownCircuitEn:          sil.NewDigitalInputPin(fwutils.LvController.String(), ShutdownCircuitEn.String()),
		MotorControllerPrechargeEn: sil.NewDigitalInputPin(fwutils.LvController.String(), MotorControllerPrechargeEn.String()),
		InverterSwitchEn:           sil.NewDigitalInputPin(fwutils.LvController.String(), InverterSwitchEn.String()),
